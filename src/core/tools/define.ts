...
type BetaZodToolParams<S extends z.ZodType> = Parameters<typeof betaZodTool<S>>[0];
...
export function defineTool<S extends z.ZodType>(spec: BetaZodToolParams<S>): Tool {
